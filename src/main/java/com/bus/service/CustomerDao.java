...
//	@Cacheable(cacheNames = "login", key = "'customer'+#email+#password")
	...
	public int saveSeat(Seat seat, Customer customer, Date date, String time , MovieDetails movie){
		List<Seat> list = new ArrayList<Seat>();
		Set<MovieDetails> movies = new HashSet<MovieDetails>();
		list.add(seat);
